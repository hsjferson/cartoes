...
public class CartaoController {
     ...
     *
     * @param clienteId do cliente a ser consultado
     * @return Lista de cartões que o cliente possui
     */
    @GetMapping(value = "/cliente/{clienteId}")
    public ResponseEntity<Response<List<CartaoDto>>>
    ...
    /**
     * Persiste um cartão na base.
     *
     * @param cartaoDto de entrada do cartao
    ...
    @PreAuthorize("hasAnyRole('EXCLUSA0')")
